...
const contentTypes = computed(() => [
  { value: 'GUIDE', label: preferencesStore.languageCode === 'en_US' ? 'Guide' : '攻略', icon: '📚' },
  { value: 'NOTE', label: preferencesStore.languageCode === 'en_US' ? 'Note' : '笔记', icon: '📝' },
  { value: 'REVIEW', label: preferencesStore.languageCode === 'en_US' ? 'Review' : '复盘', icon: '🔄' },
  { value: 'QUESTION', label: preferencesStore.languageCode === 'en_US' ? 'Question' : '求助', icon: '❓' },
  { value: 'RESOURCE', label: preferencesStore.languageCode === 'en_US' ? 'Resource' : '资源', icon: '🔗' },
  { value: 'ROADMAP', label: preferencesStore.languageCode === 'en_US' ? 'Roadmap' : '路线', icon: '🗺️' },
  { value: 'MOMENT', label: preferencesStore.languageCode === 'en_US' ? 'Moment' : '动态', icon: '💬' }
]);
...
function loadDraft() {
  ...
  try {
    ...
    form.contentType = draft.contentType ?? 'GUIDE';
      ...
      <div class="editor-main markdown-editor-main">
        <div class="post-composer-head">
          ...
          <div class="content-type-selector">
            <span class="selector-label">内容类型</span>
            <div class="type-options">
              <button
                ...
                type="button"
                class="type-option"
                :class="{ active: form.contentType === ct.value }"
                @click="form.contentType = ct.value"
              >
